...
var analyze_1 = __importDefault(require("./analyze"));
var Crowller = /** @class */ (function () {
    function Crowller(url, analyzer) {
        this.url = url;
        this.analyzer = analyzer;
        this.filePath = path_1.default.resolve(__dirname, '../data/production.json');
...
var url = 'http://www.66rpg.com';
var analyzer = analyze_1.default.getInstance();
